 ...
 *
 * Source: buildscripts/idl/idlc.py --include src --base_dir build/opt --target_arch x86_64 --header build/opt/mongo/idl/feature_flag_test_gen.h --output build/opt/mongo/idl/feature_flag_test_gen.cpp build/opt/mongo/idl/feature_flag_test.idl
 */
...
::mongo::FeatureFlag gFeatureFlagBlender{true, "5.1"_sd};
::mongo::FeatureFlag gFeatureFlagSpoon{true, "5.0"_sd};
