...
extern std::string gTestConfigNoInitOpt1;
Status addIDLTestConfigs(optionenvironment::OptionSection*);
Status storeIDLTestConfigs(const optionenvironment::Environment&);
