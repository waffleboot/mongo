...
MONGO_SERVER_PARAMETER_REGISTER(idl_1dd27471492d04bf27fcea0ae36227a340fb5f81)(InitializerContext*) {
    ...
    [[maybe_unused]] auto* scp_0 = ([]() -> ServerParameter* {
        auto* ret = makeIDLServerParameterWithStorage<ServerParameterType::kStartupAndRuntime>("deprecatedWireOpsWarningPeriodInSeconds", deprecatedWireOpsWarningPeriodInSeconds);
        ret->setOnUpdate(onUpdateOfWireOpsWarningPeriod);
