...
MONGO_MODULE_STARTUP_OPTIONS_REGISTER(idl_38ba72f5da3fbd559756fc443acd1d407f7688da)(InitializerContext*) {
    ...
    options
        .addOptionChaining("apiVersion", "apiVersion", moe::String, "set the MongoDB API version", {}, {}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
        .setSources(moe::SourceAll)
    ;

    options
        .addOptionChaining("apiStrict", "apiStrict", moe::Switch, "disable all features not included in the MongoDB Versioned API", {}, {}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
        .setSources(moe::SourceAll)
    ;

    options
        .addOptionChaining("apiDeprecationErrors", "apiDeprecationErrors", moe::Switch, "disable all features deprecated in the MongoDB Versioned API", {}, {}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
        .setSources(moe::SourceAll)
    ;
    ...
    options
        .addOptionChaining("crashOnInvalidBSONError", "crashOnInvalidBSONError", moe::Switch, "Crashes the shell if invalid BSON is returned from a call to the server. Must be paired with objcheck to provoke a BSON validation check.", {}, {}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
        .setSources(moe::SourceAllLegacy)
        .hidden()
    ;
...
MONGO_STARTUP_OPTIONS_STORE(idl_38ba72f5da3fbd559756fc443acd1d407f7688da)(InitializerContext*) {
    ...
    if (params.count("apiVersion")) {
        shellGlobalParams.apiVersion = params["apiVersion"].as<moe::OptionTypeMap<moe::String>::type>();
    }

    if (params.count("apiStrict")) {
        shellGlobalParams.apiStrict = params["apiStrict"].as<moe::OptionTypeMap<moe::Switch>::type>();
    }

    if (params.count("apiDeprecationErrors")) {
        shellGlobalParams.apiDeprecationErrors = params["apiDeprecationErrors"].as<moe::OptionTypeMap<moe::Switch>::type>();
    }
