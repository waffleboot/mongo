...
constexpr auto kVersion = "5.1.0-yangand"_sd;
constexpr int kMajorVersion = 5;
constexpr int kMinorVersion = 1;
constexpr int kPatchVersion = 1;
constexpr int kExtraVersion = -100;
constexpr auto kVersionExtraStr = "yangand"_sd;
constexpr auto kGitVersion = "e05975ed9b1eeb1ba2d2ea53d540a656805c7033"_sd;
...
{R"(cc)"_sd, R"(gcc: gcc (Ubuntu 9.3.0-17ubuntu1~20.04) 9.3.0)"_sd, true, false},
...
{R"(cxx)"_sd, R"(g++: g++ (Ubuntu 9.3.0-17ubuntu1~20.04) 9.3.0)"_sd, true, false},
{R"(cxxflags)"_sd, R"(-Woverloaded-virtual -Wpessimizing-move -Wno-maybe-uninitialized -fsized-deallocation -std=c++17)"_sd, true, false},
