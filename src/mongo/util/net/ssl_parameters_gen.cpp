...
int gTLSOCSPSlowResponderWarningSecs{5};
/**
...
MONGO_SERVER_PARAMETER_REGISTER(idl_bb7993b0c90b6b2629e378dfd88575ca0049ef7f)(InitializerContext*) {
    ...
    /**
     * How long to wait for an OCSP response before logging a warning message indicating that the responder is slow.
     */
    [[maybe_unused]] auto* scp_8 = ([]() -> ServerParameter* {
        auto* ret = makeIDLServerParameterWithStorage<ServerParameterType::kStartupOnly>("tlsOCSPSlowResponderWarningSecs", gTLSOCSPSlowResponderWarningSecs);
        ret->addBound<idl_server_parameter_detail::GTE>(1);
        return ret;
    })();
    ...
    [[maybe_unused]] auto* scp_11_0 = new IDLServerParameterDeprecatedAlias("disableNonSSLConnectionLogging", scp_11);
