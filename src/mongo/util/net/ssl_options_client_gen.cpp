...
MONGO_MODULE_STARTUP_OPTIONS_REGISTER(idl_a044e7c72974fb0cd563c47a6409e609e1ecf13c)(InitializerContext*) {
...

    {
        ...
        section
            .addOptionChaining("tls.disabledProtocols", "tlsDisabledProtocols", moe::String, "Comma separated list of TLS protocols to disable [TLS1_0,TLS1_1,TLS1_2,TLS1_3]", {"ssl.disabledProtocols"}, {"sslDisabledProtocols"}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
            .setSources(moe::SourceAll)
            .requiresOption("tls")
        ;
