...
HealthLogEntry::HealthLogEntry() : _nss(mongo::idl::preparsedValue<decltype(_nss)>()), _timestamp(mongo::idl::preparsedValue<decltype(_timestamp)>()), _severity(mongo::idl::preparsedValue<decltype(_severity)>()), _msg(mongo::idl::preparsedValue<decltype(_msg)>()), _scope(mongo::idl::preparsedValue<decltype(_scope)>()), _operation(mongo::idl::preparsedValue<decltype(_operation)>()), _data(mongo::idl::preparsedValue<decltype(_data)>()), _hasNss(false), _hasTimestamp(false), _hasSeverity(false), _hasMsg(false), _hasScope(false), _hasOperation(false), _hasData(false) {
