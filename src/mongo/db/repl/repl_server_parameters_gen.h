...
namespace feature_flags {
extern ::mongo::FeatureFlag gFileCopyBasedInitialSync;
}  // namespace feature_flags
...
constexpr auto kStoreFindAndModifyImagesInSideCollectionDefault = true;
...
constexpr auto kInitialSyncMethodDefault = "logical";

extern std::string initialSyncMethod;
}  // namespace repl
}  // namespace mongo
