...
private:
    void validateHeartbeatIntervalMillis(std::int64_t value);
    void validateHeartbeatIntervalMillis(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateHeartbeatTimeoutSecs(std::int64_t value);
    void validateHeartbeatTimeoutSecs(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateElectionTimeoutMillis(std::int64_t value);
    void validateElectionTimeoutMillis(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateCatchUpTimeoutMillis(std::int64_t value);
    void validateCatchUpTimeoutMillis(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateCatchUpTakeoverDelayMillis(std::int64_t value);
    void validateCatchUpTakeoverDelayMillis(IDLParserErrorContext& ctxt, std::int64_t value);
...
private:
    ...
    void validateConfigVersion(std::int64_t value);
    void validateConfigVersion(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateConfigTerm(std::int64_t value);
    void validateConfigTerm(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateProtocolVersion(std::int64_t value);
    void validateProtocolVersion(IDLParserErrorContext& ctxt, std::int64_t value);
