...
void HelloCommandReply::parseProtected(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    ...
    const size_t kTopologyVersionBit = 17;
    const size_t kIsmasterBit = 18;
    const size_t kIsWritablePrimaryBit = 19;
    const size_t kHostsBit = 20;
    const size_t kPassivesBit = 21;
    const size_t kArbitersBit = 22;
    const size_t kSetNameBit = 23;
    const size_t kPrimaryBit = 24;
    const size_t kSecondaryBit = 25;
    const size_t kInfoBit = 26;
    const size_t kIsreplicasetBit = 27;
    const size_t kSetVersionBit = 28;
    const size_t kArbiterOnlyBit = 29;
    const size_t kPassiveBit = 30;
    const size_t kHiddenBit = 31;
    const size_t kBuildIndexesBit = 32;
    const size_t kSlaveDelayBit = 33;
    const size_t kSecondaryDelaySecsBit = 34;
    const size_t kTagsBit = 35;
    const size_t kMeBit = 36;
    const size_t kElectionIdBit = 37;
    const size_t kLastWriteBit = 38;
    const size_t kIsImplicitDefaultMajorityWCBit = 39;
    const size_t kCwwcBit = 40;
