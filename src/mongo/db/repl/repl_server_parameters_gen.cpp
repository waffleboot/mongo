...
::mongo::FeatureFlag feature_flags::gFeatureFlagRetryableFindAndModify{true, "5.1"_sd};
::mongo::FeatureFlag feature_flags::gFileCopyBasedInitialSync{false, ""_sd};
...
AtomicWord<bool> gStoreFindAndModifyImagesInSideCollection{true};
AtomicWord<bool> enableReconfigRollbackCommittedWritesCheck{true};
std::string initialSyncMethod{"logical"};
MONGO_SERVER_PARAMETER_REGISTER(idl_8ddc250dbb1c12b1430c218ab90a19f202a22596)(InitializerContext*) {
    ...
    [[maybe_unused]] auto* scp_1 = ([]() -> ServerParameter* {
        auto* ret = new FeatureFlagServerParameter("featureFlagFileCopyBasedInitialSync", feature_flags::gFileCopyBasedInitialSync);
        return ret;
    })();
    ...
    /**
     * Specifies which method of initial sync to use. Valid options are: fileCopyBased, logical.
     */
    [[maybe_unused]] auto* scp_48 = ([]() -> ServerParameter* {
        auto* ret = makeIDLServerParameterWithStorage<ServerParameterType::kStartupOnly>("initialSyncMethod", initialSyncMethod);
        return ret;
    })();
