...
private:
    void validateVotes(std::int64_t value);
    void validateVotes(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateNewlyAdded(bool value);
    void validateNewlyAdded(IDLParserErrorContext& ctxt, bool value);

    void validatePriority(double value);
    void validatePriority(IDLParserErrorContext& ctxt, double value);

    void validateSecondaryDelaySecs(std::int64_t value);
    void validateSecondaryDelaySecs(IDLParserErrorContext& ctxt, std::int64_t value);
