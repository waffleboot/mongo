...
private:
    auto _relopTuple() const {
        return std::tuple(idl::relop::Ordering{__id}, idl::relop::Ordering{_version}, idl::relop::Ordering{_state}, idl::relop::Ordering{_registrationId}, idl::relop::Ordering{_informationalURL}, idl::relop::Ordering{_message}, idl::relop::Ordering{_userReminder});
    }
    friend bool operator==(const FreeMonStorageState& a, const FreeMonStorageState& b) {
