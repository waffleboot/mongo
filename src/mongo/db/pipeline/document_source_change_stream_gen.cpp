...
constexpr StringData kFullDocumentMode_kWhenAvailable = "whenAvailable"_sd;
constexpr StringData kFullDocumentMode_kRequired = "required"_sd;
}  // namespace 
...
FullDocumentModeEnum FullDocumentMode_parse(const IDLParserErrorContext& ctxt, StringData value) {
    ...
    if (value == kFullDocumentMode_kWhenAvailable) {
        return FullDocumentModeEnum::kWhenAvailable;
    }
    if (value == kFullDocumentMode_kRequired) {
        return FullDocumentModeEnum::kRequired;
    }
    ctxt.throwBadEnumValue(value);
}
...
StringData FullDocumentMode_serializer(FullDocumentModeEnum value) {
    ...
    if (value == FullDocumentModeEnum::kWhenAvailable) {
        return kFullDocumentMode_kWhenAvailable;
    }
    if (value == FullDocumentModeEnum::kRequired) {
        return kFullDocumentMode_kRequired;
    }
    MONGO_UNREACHABLE;
    return StringData();
}
...
constexpr StringData DocumentSourceChangeStreamUnwindTransactionSpec::kFilterFieldName;


DocumentSourceChangeStreamUnwindTransactionSpec::DocumentSourceChangeStreamUnwindTransactionSpec() : _filter(mongo::idl::preparsedValue<decltype(_filter)>()), _hasFilter(false) {
    // Used for initialization only
}
DocumentSourceChangeStreamUnwindTransactionSpec::DocumentSourceChangeStreamUnwindTransactionSpec(mongo::BSONObj filter) : _filter(std::move(filter)), _hasFilter(true) {
    // Used for initialization only
}
...
constexpr StringData DocumentSourceChangeStreamAddPreImageSpec::kFullDocumentBeforeChangeFieldName;


DocumentSourceChangeStreamAddPreImageSpec::DocumentSourceChangeStreamAddPreImageSpec() : _fullDocumentBeforeChange(mongo::idl::preparsedValue<decltype(_fullDocumentBeforeChange)>()), _hasFullDocumentBeforeChange(false) {
    // Used for initialization only
}
DocumentSourceChangeStreamAddPreImageSpec::DocumentSourceChangeStreamAddPreImageSpec(mongo::FullDocumentBeforeChangeModeEnum fullDocumentBeforeChange) : _fullDocumentBeforeChange(std::move(fullDocumentBeforeChange)), _hasFullDocumentBeforeChange(true) {
    // Used for initialization only
}


DocumentSourceChangeStreamAddPreImageSpec DocumentSourceChangeStreamAddPreImageSpec::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<DocumentSourceChangeStreamAddPreImageSpec>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
void DocumentSourceChangeStreamAddPreImageSpec::parseProtected(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    std::bitset<1> usedFields;
...
void DocumentSourceChangeStreamAddPreImageSpec::serialize(BSONObjBuilder* builder) const {
...
BSONObj DocumentSourceChangeStreamAddPreImageSpec::toBSON() const {
    BSONObjBuilder builder;
    serialize(&builder);
    return builder.obj();
}

constexpr StringData DocumentSourceChangeStreamAddPostImageSpec::kFullDocumentFieldName;


DocumentSourceChangeStreamAddPostImageSpec::DocumentSourceChangeStreamAddPostImageSpec() : _fullDocument(mongo::idl::preparsedValue<decltype(_fullDocument)>()), _hasFullDocument(false) {
    // Used for initialization only
}
DocumentSourceChangeStreamAddPostImageSpec::DocumentSourceChangeStreamAddPostImageSpec(mongo::FullDocumentModeEnum fullDocument) : _fullDocument(std::move(fullDocument)), _hasFullDocument(true) {
    // Used for initialization only
}


DocumentSourceChangeStreamAddPostImageSpec DocumentSourceChangeStreamAddPostImageSpec::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<DocumentSourceChangeStreamAddPostImageSpec>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
void DocumentSourceChangeStreamAddPostImageSpec::parseProtected(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    std::bitset<1> usedFields;
...
void DocumentSourceChangeStreamAddPostImageSpec::serialize(BSONObjBuilder* builder) const {
...
BSONObj DocumentSourceChangeStreamAddPostImageSpec::toBSON() const {
    BSONObjBuilder builder;
    serialize(&builder);
    return builder.obj();
}
