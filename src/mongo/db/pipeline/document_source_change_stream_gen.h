...
static constexpr uint32_t kNumFullDocumentModeEnum = 4;
...
public:
    ...
    DocumentSourceChangeStreamUnwindTransactionSpec(mongo::BSONObj filter);
...
/**
 * A document used to specify the $_internalChangeStreamAddPreImage stage of an aggregation pipeline.
 */
class DocumentSourceChangeStreamAddPreImageSpec {
public:
    static constexpr auto kFullDocumentBeforeChangeFieldName = "fullDocumentBeforeChange"_sd;

    DocumentSourceChangeStreamAddPreImageSpec();
    DocumentSourceChangeStreamAddPreImageSpec(mongo::FullDocumentBeforeChangeModeEnum fullDocumentBeforeChange);

    static DocumentSourceChangeStreamAddPreImageSpec parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);
    void serialize(BSONObjBuilder* builder) const;
    BSONObj toBSON() const;
...
/**
 * A document used to specify the $_internalChangeStreamAddPostImage stage of an aggregation pipeline.
 */
class DocumentSourceChangeStreamAddPostImageSpec {
public:
    static constexpr auto kFullDocumentFieldName = "fullDocument"_sd;

    DocumentSourceChangeStreamAddPostImageSpec();
    DocumentSourceChangeStreamAddPostImageSpec(mongo::FullDocumentModeEnum fullDocument);

    static DocumentSourceChangeStreamAddPostImageSpec parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);
    void serialize(BSONObjBuilder* builder) const;
    BSONObj toBSON() const;
