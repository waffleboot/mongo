...
public:
    ...
    static constexpr auto kOriginalSpecFieldName = "originalSpec"_sd;
    ...
    const boost::optional<mongo::BSONObj>& getOriginalSpec() const& { return _originalSpec; }
    void getOriginalSpec() && = delete;
    void setOriginalSpec(boost::optional<mongo::BSONObj> value) & {  _originalSpec = std::move(value);  }
...
private:
    ...
    boost::optional<mongo::BSONObj> _originalSpec;
...
public:
    ...
    explicit ListIndexes(NamespaceStringOrUUID nssOrUUID);
