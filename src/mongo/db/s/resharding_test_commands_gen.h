...
public:
    ...
    explicit TestReshardCloneCollection(mongo::NamespaceString commandParameter);
    explicit TestReshardCloneCollection(mongo::NamespaceString commandParameter, mongo::Timestamp atClusterTime, mongo::NamespaceString outputNs, mongo::BSONObj shardKey, mongo::ShardId shardId, mongo::UUID uuid);
