...
private:
    auto _relopTuple() const {
        return std::tuple(idl::relop::Ordering{_reshardingUUID}, idl::relop::Ordering{_type});
    }
    friend bool operator==(const ReshardingChangeEventO2Field& a, const ReshardingChangeEventO2Field& b) {
