...
private:
    auto _relopTuple() const {
        return std::tuple(idl::relop::Ordering{_clusterTime}, idl::relop::Ordering{_ts});
    }
    friend bool operator==(const ReshardingDonorOplogId& a, const ReshardingDonorOplogId& b) {
