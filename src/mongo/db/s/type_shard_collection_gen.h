...
public:
    static constexpr auto kAllowAutoSplitFieldName = "allowAutoSplit"_sd;
     ...
     */
    bool getAllowAutoSplit() const { return _allowAutoSplit; }
    void setAllowAutoSplit(bool value) & {  _allowAutoSplit = std::move(value);  }
