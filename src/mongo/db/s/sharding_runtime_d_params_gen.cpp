...
AtomicWord<int> rangeDeleterBatchSize{128};
...
MONGO_SERVER_PARAMETER_REGISTER(idl_0f4ff67704659a8aecb5278d23668d0561d2d29b)(InitializerContext*) {
    /**
     * The maximum number of documents in each batch to delete during the cleanup stage of chunk migration (or the cleanupOrphaned command). A value of 0 indicates that the system chooses the default value (128).
     */
