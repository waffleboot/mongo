 ...
 */
namespace  {
constexpr StringData kDDLCoordinatorType_kMovePrimary = "movePrimary"_sd;
...
constexpr StringData kDDLCoordinatorType_kRefineCollectionShardKey = "refineCollectionShardKey"_sd;
}  // namespace 

DDLCoordinatorTypeEnum DDLCoordinatorType_parse(const IDLParserErrorContext& ctxt, StringData value) {
    if (value == kDDLCoordinatorType_kMovePrimary) {
        return DDLCoordinatorTypeEnum::kMovePrimary;
    }
    ...
    if (value == kDDLCoordinatorType_kRefineCollectionShardKey) {
        return DDLCoordinatorTypeEnum::kRefineCollectionShardKey;
    }
    ctxt.throwBadEnumValue(value);
}

StringData DDLCoordinatorType_serializer(DDLCoordinatorTypeEnum value) {
    if (value == DDLCoordinatorTypeEnum::kMovePrimary) {
        return kDDLCoordinatorType_kMovePrimary;
    }
    ...
    if (value == DDLCoordinatorTypeEnum::kRefineCollectionShardKey) {
        return kDDLCoordinatorType_kRefineCollectionShardKey;
    }
    MONGO_UNREACHABLE;
    return StringData();
}
