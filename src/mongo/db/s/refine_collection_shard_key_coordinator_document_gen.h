...
/**
 * Object with neccessary fields to refine a collection's shard key
 */
class RefineCollectionShardKeyCoordinatorDocument {
public:
    ...
    static RefineCollectionShardKeyCoordinatorDocument parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);
