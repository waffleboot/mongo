...
public:
    ...
    explicit ShardsvrRenameCollectionParticipant(NamespaceString nss);
    ShardsvrRenameCollectionParticipant(NamespaceString nss, mongo::UUID sourceUUID);
...
public:
    ...
    explicit ShardsvrRenameCollectionUnblockParticipant(NamespaceString nss);
    ShardsvrRenameCollectionUnblockParticipant(NamespaceString nss, mongo::UUID sourceUUID);
