...
public:
    ...
    explicit InsertCommandRequest(NamespaceString nss);
    InsertCommandRequest(NamespaceString nss, std::vector<mongo::BSONObj> documents);
...
public:
    ...
    explicit UpdateCommandRequest(NamespaceString nss);
    UpdateCommandRequest(NamespaceString nss, std::vector<mongo::write_ops::UpdateOpEntry> updates);
...
public:
    ...
    explicit DeleteCommandRequest(NamespaceString nss);
    DeleteCommandRequest(NamespaceString nss, std::vector<mongo::write_ops::DeleteOpEntry> deletes);
...
public:
    ...
    explicit FindAndModifyCommandRequest(NamespaceString nss);
