...
public:
    ...
    explicit EndSessionsFromClient(std::vector<mongo::LogicalSessionFromClient> commandParameter);
...
public:
    ...
    explicit RefreshSessionsFromClient(std::vector<mongo::LogicalSessionFromClient> commandParameter);
