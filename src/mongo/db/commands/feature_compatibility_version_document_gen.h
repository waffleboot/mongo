...
private:
    void validatePreviousVersion(ServerGlobalParams::FeatureCompatibility::Version value);
    void validatePreviousVersion(IDLParserErrorContext& ctxt, ServerGlobalParams::FeatureCompatibility::Version value);

private:
    auto _relopTuple() const {
        return std::tuple(idl::relop::Ordering{__id}, idl::relop::Ordering{_version}, idl::relop::Ordering{_targetVersion}, idl::relop::Ordering{_previousVersion}, idl::relop::Ordering{_changeTimestamp});
    }
    friend bool operator==(const FeatureCompatibilityVersionDocument& a, const FeatureCompatibilityVersionDocument& b) {
