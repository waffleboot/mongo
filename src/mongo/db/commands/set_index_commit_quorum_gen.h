...
public:
    ...
    explicit SetIndexCommitQuorum(NamespaceString nss);
    SetIndexCommitQuorum(NamespaceString nss, std::vector<std::string> indexNames, mongo::CommitQuorumOptions commitQuorum);
