...
private:
    void validateCommitDelayMS(std::int32_t value);
    void validateCommitDelayMS(IDLParserErrorContext& ctxt, std::int32_t value);
...
public:
    ...
    explicit CreateUserCommand(std::string commandParameter);
    explicit CreateUserCommand(std::string commandParameter, std::vector<mongo::RoleNameOrString> roles);
...
public:
    ...
    explicit UpdateUserCommand(std::string commandParameter);
...
public:
    ...
    explicit DropUserCommand(std::string commandParameter);
...
public:
    ...
    explicit GrantRolesToUserCommand(std::string commandParameter);
    explicit GrantRolesToUserCommand(std::string commandParameter, std::vector<mongo::RoleNameOrString> roles);
...
public:
    ...
    explicit RevokeRolesFromUserCommand(std::string commandParameter);
    explicit RevokeRolesFromUserCommand(std::string commandParameter, std::vector<mongo::RoleNameOrString> roles);
...
public:
    ...
    explicit CreateRoleCommand(std::string commandParameter);
    explicit CreateRoleCommand(std::string commandParameter, std::vector<mongo::Privilege> privileges, std::vector<mongo::RoleNameOrString> roles);
...
public:
    ...
    explicit UpdateRoleCommand(std::string commandParameter);
...
public:
    ...
    explicit GrantPrivilegesToRoleCommand(std::string commandParameter);
    explicit GrantPrivilegesToRoleCommand(std::string commandParameter, std::vector<mongo::Privilege> privileges);
...
public:
    ...
    explicit RevokePrivilegesFromRoleCommand(std::string commandParameter);
    explicit RevokePrivilegesFromRoleCommand(std::string commandParameter, std::vector<mongo::Privilege> privileges);
...
public:
    ...
    explicit GrantRolesToRoleCommand(std::string commandParameter);
    explicit GrantRolesToRoleCommand(std::string commandParameter, std::vector<mongo::RoleNameOrString> roles);
...
public:
    ...
    explicit RevokeRolesFromRoleCommand(std::string commandParameter);
    explicit RevokeRolesFromRoleCommand(std::string commandParameter, std::vector<mongo::RoleNameOrString> roles);
...
public:
    ...
    explicit DropRoleCommand(std::string commandParameter);
...
public:
    ...
    explicit UsersInfoCommand(mongo::auth::UsersInfoCommandArg commandParameter);
...
public:
    ...
    explicit RolesInfoCommand(mongo::auth::RolesInfoCommandArg commandParameter);
...
public:
    ...
    MergeAuthzCollectionsCommand(std::string tempUsersCollection, std::string tempRolesCollection, std::string db);
    ...
    void setTempUsersCollection(StringData value) & { auto _tmpValue = value.toString();  _tempUsersCollection = std::move(_tmpValue); _hasTempUsersCollection = true; }
    ...
    void setTempRolesCollection(StringData value) & { auto _tmpValue = value.toString();  _tempRolesCollection = std::move(_tmpValue); _hasTempRolesCollection = true; }
...
private:
    ...
    bool _drop{false};
    std::string _dbName;
    bool _hasTempUsersCollection : 1;
    bool _hasTempRolesCollection : 1;
    bool _hasDb : 1;
    bool _hasDbName : 1;
};
