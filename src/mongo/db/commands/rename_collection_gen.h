...
public:
    ...
    explicit RenameCollectionCommand(mongo::NamespaceString commandParameter);
    explicit RenameCollectionCommand(mongo::NamespaceString commandParameter, mongo::NamespaceString to);
