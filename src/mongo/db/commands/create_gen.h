...
public:
    ...
    explicit CreateCommand(NamespaceString nss);
...
private:
    void validateSize(std::int64_t value);
    void validateSize(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateMax(std::int64_t value);
    void validateMax(IDLParserErrorContext& ctxt, std::int64_t value);
