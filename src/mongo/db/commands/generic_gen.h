...
public:
    ...
    explicit LogMessageCommand(std::string commandParameter);
...
private:
    void validateDebugLevel(std::int32_t value);
    void validateDebugLevel(IDLParserErrorContext& ctxt, std::int32_t value);
