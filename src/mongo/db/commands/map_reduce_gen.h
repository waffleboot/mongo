...
public:
    ...
    explicit MapReduceCommandRequest(NamespaceString nss);
    MapReduceCommandRequest(NamespaceString nss, mongo::MapReduceJavascriptCode map, mongo::MapReduceJavascriptCode reduce, mongo::MapReduceOutOptions outOptions);
