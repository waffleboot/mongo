...
public:
    ...
    VectorClockDocument();
    VectorClockDocument(mongo::Timestamp configTime, mongo::Timestamp topologyTime);
    ...
    void setConfigTime(mongo::Timestamp value) & {  _configTime = std::move(value); _hasConfigTime = true; }

    /**
     * Persists the topologyTime component of the vector clock
     */
    const mongo::Timestamp& getTopologyTime() const { return _topologyTime; }
    void setTopologyTime(mongo::Timestamp value) & {  _topologyTime = std::move(value); _hasTopologyTime = true; }
...
private:
    ...
    mongo::Timestamp _configTime;
    mongo::Timestamp _topologyTime;
    bool _hasConfigTime : 1;
    bool _hasTopologyTime : 1;
};
