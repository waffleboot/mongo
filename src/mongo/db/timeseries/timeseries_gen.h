...
private:
    void validateBucketMaxSpanSeconds(std::int32_t value);
    void validateBucketMaxSpanSeconds(IDLParserErrorContext& ctxt, std::int32_t value);
...
constexpr auto kTimeseriesIdleBucketExpiryMemoryUsageThresholdDefault = 104857600;

extern std::int32_t gTimeseriesIdleBucketExpiryMemoryUsageThreshold;
}  // namespace mongo
