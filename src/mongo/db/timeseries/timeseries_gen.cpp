...
std::int32_t gTimeseriesIdleBucketExpiryMemoryUsageThreshold{104857600};
MONGO_SERVER_PARAMETER_REGISTER(idl_36ac8765eed4b8e5fefd8fc9452f7e1ca50d4ea5)(InitializerContext*) {
    ...
    /**
     * The threshold for bucket catalog memory usage above which idle buckets will be expired
     */
    [[maybe_unused]] auto* scp_2 = ([]() -> ServerParameter* {
        auto* ret = makeIDLServerParameterWithStorage<ServerParameterType::kStartupOnly>("timeseriesIdleBucketExpiryMemoryUsageThreshold", gTimeseriesIdleBucketExpiryMemoryUsageThreshold);
        ret->addBound<idl_server_parameter_detail::GTE>(1);
        return ret;
    })();
