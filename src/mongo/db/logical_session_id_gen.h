...
/**
 * Internal sessiond id fields
 */
class InternalSessionFields {
public:
    static constexpr auto kStmtIdFieldName = "stmtId"_sd;
    static constexpr auto kTxnNumberFieldName = "txnNumber"_sd;
    static constexpr auto kTxnUUIDFieldName = "txnUUID"_sd;

    InternalSessionFields();

    static InternalSessionFields parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);
    void serialize(BSONObjBuilder* builder) const;
    BSONObj toBSON() const;

    /**
     * Used for internal sessions only.
     */
     ...
     * Used for internal sessions only.
     */
    const boost::optional<mongo::UUID>& getTxnUUID() const& { return _txnUUID; }
    void getTxnUUID() && = delete;
    void setTxnUUID(boost::optional<mongo::UUID> value) & {  _txnUUID = std::move(value);  }
...
private:
    ...
    boost::optional<mongo::UUID> _txnUUID;
};
...
public:
    static constexpr auto kInternalSessionFieldsFieldName = "InternalSessionFields"_sd;
     ...
     * Internal sessiond id fields
     */
    const mongo::InternalSessionFields& getInternalSessionFields() const { return _internalSessionFields; }
    mongo::InternalSessionFields& getInternalSessionFields() { return _internalSessionFields; }
    void setInternalSessionFields(mongo::InternalSessionFields value) & {  _internalSessionFields = std::move(value);  }

    /**
     * Used for internal sessions only.
     */
    const  boost::optional<std::int64_t> getTxnNumber() const { return _internalSessionFields.getTxnNumber(); }
    /**
     * Used for internal sessions only.
     */
    const  boost::optional<std::int32_t> getStmtId() const { return _internalSessionFields.getStmtId(); }
    /**
     * Used for internal sessions only.
     */
    const  boost::optional<mongo::UUID>& getTxnUUID() const { return _internalSessionFields.getTxnUUID(); }
...
private:
    mongo::InternalSessionFields _internalSessionFields;
    mongo::UUID _id;
