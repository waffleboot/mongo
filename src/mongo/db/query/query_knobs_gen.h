...
constexpr auto kInternalMaxSubPipelineViewDepthDefault = 20;

extern AtomicWord<long long> internalMaxSubPipelineViewDepth;
...
constexpr auto kInternalQuerySlotBasedExecutionHashAggMemoryUseSampleRateDefault = 0.5;

extern AtomicDouble internalQuerySBEAggMemoryUseSampleRate;
constexpr auto kInternalQuerySlotBasedExecutionHashAggApproxMemoryUseInBytesBeforeSpillDefault = 1024 * 1024;

extern AtomicWord<long long> internalQuerySBEAggApproxMemoryUseInBytesBeforeSpill;
...
constexpr auto kInternalQueryMaxNAccumulatorBytesDefault = 100 * 1024 * 1024;

extern AtomicWord<int> internalQueryMaxNAccumulatorBytes;
