...
public:
    ...
    explicit FindCommandRequest(NamespaceStringOrUUID nssOrUUID);
...
private:
    void validateSkip(std::int64_t value);
    void validateSkip(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateLimit(std::int64_t value);
    void validateLimit(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateBatchSize(std::int64_t value);
    void validateBatchSize(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateNtoreturn(std::int64_t value);
    void validateNtoreturn(IDLParserErrorContext& ctxt, std::int64_t value);

    void validateMaxTimeMS(std::int32_t value);
    void validateMaxTimeMS(IDLParserErrorContext& ctxt, std::int32_t value);
