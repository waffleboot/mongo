...
void FindCommandRequest::parseProtected(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    ...
    const size_t kMaxTimeMSBit = 28;
    const size_t kReadConcernBit = 29;
    const size_t kLegacyRuntimeConstantsBit = 30;
    const size_t kDbNameBit = 31;
