...
::mongo::FeatureFlag feature_flags::gTimeseriesUpdatesAndDeletes{false, ""_sd};
::mongo::FeatureFlag feature_flags::gTimeseriesMetricIndexes{false, ""_sd};
...
MONGO_SERVER_PARAMETER_REGISTER(idl_00f530d5d6eec2fd73d1b0b17c85c58438bf160b)(InitializerContext*) {
    ...
    /**
     * When enabled, support secondary indexes on time-series measurements
     */
    [[maybe_unused]] auto* scp_2 = ([]() -> ServerParameter* {
        auto* ret = new FeatureFlagServerParameter("featureFlagTimeseriesMetricIndexes", feature_flags::gTimeseriesMetricIndexes);
        return ret;
    })();
