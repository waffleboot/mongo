...
public:
    ...
    explicit ClearJumboFlag(mongo::NamespaceString commandParameter);
...
public:
    ...
    explicit ConfigsvrClearJumboFlag(mongo::NamespaceString commandParameter);
    explicit ConfigsvrClearJumboFlag(mongo::NamespaceString commandParameter, mongo::OID epoch, mongo::BSONObj minKey, mongo::BSONObj maxKey);
