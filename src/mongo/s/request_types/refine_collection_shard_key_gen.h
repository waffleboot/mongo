...
public:
    ...
    explicit RefineCollectionShardKey(mongo::NamespaceString commandParameter);
    explicit RefineCollectionShardKey(mongo::NamespaceString commandParameter, mongo::BSONObj key);
...
public:
    ...
    explicit ConfigsvrRefineCollectionShardKey(mongo::NamespaceString commandParameter);
    explicit ConfigsvrRefineCollectionShardKey(mongo::NamespaceString commandParameter, mongo::BSONObj key, mongo::OID epoch);
