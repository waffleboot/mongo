...
public:
    ...
    explicit _flushRoutingTableCacheUpdates(mongo::NamespaceString commandParameter);
 ...
 */
class _flushRoutingTableCacheUpdatesWithWriteConcern {
public:
    using Reply = void;
    ...
    explicit _flushRoutingTableCacheUpdatesWithWriteConcern(mongo::NamespaceString commandParameter);

    static _flushRoutingTableCacheUpdatesWithWriteConcern parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);
    static _flushRoutingTableCacheUpdatesWithWriteConcern parse(const IDLParserErrorContext& ctxt, const OpMsgRequest& request);
    void serialize(const BSONObj& commandPassthroughFields, BSONObjBuilder* builder) const;
    OpMsgRequest serialize(const BSONObj& commandPassthroughFields) const;
    BSONObj toBSON(const BSONObj& commandPassthroughFields) const;
