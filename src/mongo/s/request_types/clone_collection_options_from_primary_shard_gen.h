...
public:
    ...
    explicit CloneCollectionOptionsFromPrimaryShard(mongo::NamespaceString commandParameter);
    explicit CloneCollectionOptionsFromPrimaryShard(mongo::NamespaceString commandParameter, std::string primaryShard);
