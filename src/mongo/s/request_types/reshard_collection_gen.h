...
public:
    ...
    explicit ReshardCollection(mongo::NamespaceString commandParameter);
    explicit ReshardCollection(mongo::NamespaceString commandParameter, mongo::BSONObj key);
...
public:
    ...
    explicit ConfigsvrReshardCollection(mongo::NamespaceString commandParameter);
    explicit ConfigsvrReshardCollection(mongo::NamespaceString commandParameter, mongo::BSONObj key);
