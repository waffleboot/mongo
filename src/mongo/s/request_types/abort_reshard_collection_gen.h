...
public:
    ...
    explicit AbortReshardCollection(mongo::NamespaceString commandParameter);
...
public:
    ...
    explicit ConfigsvrAbortReshardCollection(mongo::NamespaceString commandParameter);
...
public:
    ...
    explicit ShardsvrAbortReshardCollection(mongo::UUID commandParameter);
    explicit ShardsvrAbortReshardCollection(mongo::UUID commandParameter, bool userCanceled);
