...
public:
    ...
    explicit _flushReshardingStateChange(mongo::NamespaceString commandParameter);
    explicit _flushReshardingStateChange(mongo::NamespaceString commandParameter, mongo::UUID reshardingUUID);
