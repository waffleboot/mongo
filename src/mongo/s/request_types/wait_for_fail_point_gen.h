...
public:
    ...
    explicit WaitForFailPoint(std::string commandParameter);
    explicit WaitForFailPoint(std::string commandParameter, std::int64_t timesEntered, std::int64_t maxTimeMS);
