...
public:
    ...
    explicit CleanupReshardCollection(mongo::NamespaceString commandParameter);
...
public:
    ...
    explicit ConfigsvrCleanupReshardCollection(mongo::NamespaceString commandParameter);
...
public:
    ...
    explicit ShardsvrCleanupReshardCollection(mongo::NamespaceString commandParameter);
    explicit ShardsvrCleanupReshardCollection(mongo::NamespaceString commandParameter, mongo::UUID reshardingUUID);
