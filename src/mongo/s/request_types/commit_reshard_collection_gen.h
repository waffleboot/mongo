...
public:
    ...
    explicit CommitReshardCollection(mongo::NamespaceString commandParameter);
...
public:
    ...
    explicit ConfigsvrCommitReshardCollection(mongo::NamespaceString commandParameter);
...
public:
    ...
    explicit ShardsvrCommitReshardCollection(mongo::NamespaceString commandParameter);
    explicit ShardsvrCommitReshardCollection(mongo::NamespaceString commandParameter, mongo::UUID reshardingUUID);
