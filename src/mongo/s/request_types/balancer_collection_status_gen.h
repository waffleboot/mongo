...
public:
    ...
    explicit BalancerCollectionStatus(mongo::NamespaceString commandParameter);
...
public:
    ...
    explicit ConfigsvrBalancerCollectionStatus(mongo::NamespaceString commandParameter);
